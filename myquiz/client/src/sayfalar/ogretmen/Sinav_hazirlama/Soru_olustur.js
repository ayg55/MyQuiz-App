...
import { addQuestionToExam, editQuestionById } from "../../../api_cagrilari/sinavlar";
import { HideLoading, ShowLoading } from "../../../redux/loaderSlice";

function Soru_olustur({
  ...
  return (
    <Modal
      title={selectedQuestion ? "Soruyu Düzenle" : "Soru Ekle"}
    ...
    >
      ...
      >
        ...
        <Form.Item name="correctOption" label="Doğru Şık">
          <input type="text" />
        </Form.Item>
        ...
        <div className="flex justify-end mt-2 gap-3">
          ...
          <button className="dark-contained-btn">Soruyu Kaydet</button>
        </div>
      </Form>
    </Modal>
  );
